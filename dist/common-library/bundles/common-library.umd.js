(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('primeng/tabview'), require('@angular/core'), require('ng-jhipster'), require('@ngx-translate/core'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('common-library', ['exports', '@angular/common', 'primeng/tabview', '@angular/core', 'ng-jhipster', '@ngx-translate/core', '@angular/forms'], factory) :
    (factory((global['common-library'] = {}),global.ng.common,global.tabview,global.ng.core,global.ngJhipster,global.core,global.ng.forms));
}(this, (function (exports,common,tabview,i0,ngJhipster,core,forms) { 'use strict';
    ...
    var CommonLibraryService = /** @class */ (function () {
        ...
        /** @nocollapse */ CommonLibraryService.ngInjectableDef = i0.defineInjectable({ factory: function CommonLibraryService_Factory() { return new CommonLibraryService(); }, token: CommonLibraryService, providedIn: "root" });
    ...
    var TemplateFieldsComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        TemplateFieldsComponent.ctorParameters = function () {
            return [
                { type: forms.FormBuilder }
            ];
        };
        TemplateFieldsComponent.propDecorators = {
            tabItems: [{ type: i0.Input }],
            editorData: [{ type: i0.Input }],
            autoFocus: [{ type: i0.Input }],
            apiToken: [{ type: i0.Input }],
            emailTemplates: [{ type: i0.Input }]
        };
    ...
    var CkEditorComponent = /** @class */ (function () {
        ...
        CkEditorComponent.propDecorators = {
            editorValue: [{ type: i0.Input }],
            apiToken: [{ type: i0.Input }],
            autoFocus: [{ type: i0.Input }],
            editorId: [{ type: i0.Input }],
            editorContainer: [{ type: i0.ViewChild, args: ['editorContainer',] }],
    ...
    var CommonLibraryModule = /** @class */ (function () {
        ...
        CommonLibraryModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, tabview.TabViewModule, core.TranslateModule, forms.FormsModule, forms.ReactiveFormsModule],
                        exports: [CommonLibraryComponent, CkEditorComponent, TemplateFieldsComponent],
                        providers: [{ provide: ngJhipster.JhiLanguageService, useClass: ngJhipster.JhiLanguageService }]
                    },] }
        ];
        /** @nocollapse */
    ...
    exports.CommonLibraryService = CommonLibraryService;
    exports.CommonLibraryComponent = CommonLibraryComponent;
    exports.TemplateFieldsComponent = TemplateFieldsComponent;
